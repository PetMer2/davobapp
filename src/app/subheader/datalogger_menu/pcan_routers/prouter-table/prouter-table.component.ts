...
@Component({
  selector: 'app-prouter-table',
  templateUrl: './prouter-table.component.html',
  styleUrls: ['./prouter-table.component.css']
})
export class ProuterTableComponent implements OnInit {
