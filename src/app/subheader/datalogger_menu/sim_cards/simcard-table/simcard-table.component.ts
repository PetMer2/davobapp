...
@Component({
  selector: 'app-simcard-table',
  templateUrl: './simcard-table.component.html',
  styleUrls: ['./simcard-table.component.css']
})
export class SimcardTableComponent implements OnInit {
