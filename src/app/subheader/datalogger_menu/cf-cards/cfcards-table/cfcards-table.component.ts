...
@Component({
  selector: 'app-cfcards-table',
  templateUrl: './cfcards-table.component.html',
  styleUrls: ['./cfcards-table.component.css']
})
export class CfcardsTableComponent implements OnInit {
