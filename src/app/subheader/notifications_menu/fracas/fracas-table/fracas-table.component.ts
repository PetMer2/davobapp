...
@Component({
  selector: 'app-fracas-table',
  templateUrl: './fracas-table.component.html',
  styleUrls: ['./fracas-table.component.css']
})
export class FracasTableComponent implements OnInit {
